...
graph TD
    ...
    ANALYZE_REQUEST --> REQUEST_TYPE{ DETERMINE REQUEST TYPE }
    ...
    CHECK_CACHE --> CACHE_RESULT{ DETERMINE CACHE RESULT }
    ...
    COMPILE_RESEARCH --> QUALITY_GATE{ DETERMINE QUALITY GATE }
    ...
    QUALITY_GATE -->|"QUALITY SCORE >= 5"| DETERMINE_ROUTING{ DETERMINE DETERMINE ROUTING }
